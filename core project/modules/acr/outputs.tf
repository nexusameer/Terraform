output "acr_id" {
  ...
  value       = azurerm_container_registry.azcrwedpcore.id
}

output "acr_login_server_name" {
  description = "The login server URL for the container registry."
  value       = azurerm_container_registry.azcrwedpcore.login_server
}

output "core_acr_name" {
  value = azurerm_container_registry.azcrwedpcore.name
}
