output "batch_account_id" {
  value = azurerm_batch_account.az-ba-we-dp-core.id
}
...
output "batch_account_name" {
  value = azurerm_batch_account.az-ba-we-dp-core.name
}
...
output "batch_primary_access_key" {
  value = azurerm_batch_account.az-ba-we-dp-core.primary_access_key
}
