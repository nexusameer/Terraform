...
resource "azurerm_batch_account" "az-ba-we-dp-core" {
...
resource "azurerm_role_assignment" "batch_contributor" {
  ...
  scope                = azurerm_batch_account.az-ba-we-dp-core.id
  depends_on           = [azurerm_batch_account.az-ba-we-dp-core]
}
...
resource "azurerm_private_endpoint" "batch_private_endpoint" {
  ...
  private_service_connection {
    ...
    private_connection_resource_id = azurerm_batch_account.az-ba-we-dp-core.id
...
resource "azurerm_batch_pool" "batch_pool" {
  ...
  resource_group_name = var.core_rg
  account_name        = azurerm_batch_account.az-ba-we-dp-core.name
