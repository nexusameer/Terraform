...
environment                  = "STAG"
core_subscription_id         = "fde0230c-3ea6-4f70-b411-02eefad08e91"
app_subscription_id          = "2f798d52-8ad4-4614-b94e-fe66a8c2e8c3"
management_subscription_id   = "54e40e11-f09e-481d-a80d-22eb8ad32ee6"
kcri_subscription_id         = "a7aee621-bac4-4041-9c5e-9cb3acb47ebf"
...
vnet_address_space        = ["10.253.38.0/23", "10.253.40.0/24", "10.253.41.0/24"]
sensor_vnet_address_space = ["10.253.42.0/26"]
vnet_ch_address_space     = ["10.253.44.0/23"]
kvap_address_space        = ["10.253.42.64/26"]
...
sensor_pe_address_prefix            = ["10.253.39.64/27"]
sensor_batch_account_address_prefix = ["10.253.39.96/28"]
sensor_functionapp_address_prefix   = ["10.253.39.128/28"]
sensor_db_address_prefix            = ["10.253.39.112/28"]
sensor_bastion_address_prefix       = ["10.253.41.0/26"]
...
webapp_sensor_address_prefix           = ["10.253.42.0/28"]
virtual_machine_sensor_address_prefix  = ["10.253.42.32/28"]
private_endpoint_sensor_address_prefix = ["10.253.42.16/28"]
...
aks_ch_address_prefix    = ["10.253.44.0/24"]
ch_pe_address_prefix     = ["10.253.45.16/28"]
ch_db_address_prefix     = ["10.253.45.0/28"]
ch_appgtw_address_prefix = ["10.253.45.32/27"]
...
d_bricks_container_address_prefix          = ["10.253.38.0/25"]
pe_d_bricks_managed_storage_address_prefix = ["10.253.39.16/28"]
pe_d_bricks_cp_address_prefix              = ["10.253.39.0/28"]
d_bricks_host_address_prefix               = ["10.253.38.128/25"]
...
ml_batch_account_address_prefix  = ["10.253.39.176/28"]
ml_function_app_address_prefix   = ["10.253.39.192/28"]
ml_pe_subnet_address_prefix      = ["10.253.39.208/28"]
lss_batch_account_address_prefix = ["10.253.40.0/28"]
lss_function_app_address_prefix  = ["10.253.40.16/28"]
lss_pe_address_prefix            = ["10.253.40.32/28"]
inv_db_address_prefix            = ["10.253.40.80/28"]
inv_function_app_address_prefix  = ["10.253.40.96/28"]
inv_vm_address_prefix            = ["10.253.40.128/28"]
inv_pe_address_prefix            = ["10.253.40.112/28"]
event_hub_address_prefix         = ["10.253.40.176/28"]


kvap_vm_subnet_name    = "AZ_SNET_WE_VM"
kvap_vm_address_prefix = ["10.253.42.64/28"]
...
############################ Action Group #################################
recipient = "dcstgenv.notifications@digycorp.com"
