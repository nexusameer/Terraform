...
app_subscription_id          = "8fe971e5-6ea8-448c-9936-ca218a1e908c"
management_subscription_id   = "54e40e11-f09e-481d-a80d-22eb8ad32ee6"
kcri_subscription_id         = "a04d67fe-e2b1-46de-aa59-21135ede95a2"
...
vnet_address_space        = ["10.253.22.0/23", "10.253.24.0/24"]
sensor_vnet_address_space = ["10.253.25.0/26"]
vnet_ch_address_space     = ["10.253.26.0/24"]
kvap_address_space        = ["10.253.25.64/26"]
...
sensor_pe_address_prefix            = ["10.253.22.192/27"]
sensor_batch_account_address_prefix = ["10.253.22.224/28"]
sensor_functionapp_address_prefix   = ["10.253.23.0/28"]
sensor_db_address_prefix            = ["10.253.22.240/28"]
sensor_bastion_address_prefix       = ["10.253.24.128/26"]
...
webapp_sensor_address_prefix           = ["10.253.25.0/28"]
virtual_machine_sensor_address_prefix  = ["10.253.25.32/28"]
private_endpoint_sensor_address_prefix = ["10.253.25.16/28"]
...
aks_ch_address_prefix    = ["10.253.26.0/25"]
ch_pe_address_prefix     = ["10.253.26.144/28"]
ch_db_address_prefix     = ["10.253.26.128/28"]
ch_appgtw_address_prefix = ["10.253.26.160/27"]
...
d_bricks_container_address_prefix          = ["10.253.22.0/26"]
pe_d_bricks_managed_storage_address_prefix = ["10.253.22.144/28"]
pe_d_bricks_cp_address_prefix              = ["10.253.22.128/28"]
d_bricks_host_address_prefix               = ["10.253.22.64/26"]
...
ml_batch_account_address_prefix  = ["10.253.23.48/28"]
ml_function_app_address_prefix   = ["10.253.23.64/28"]
ml_pe_subnet_address_prefix      = ["10.253.23.80/28"]
lss_batch_account_address_prefix = ["10.253.23.128/28"]
lss_function_app_address_prefix  = ["10.253.23.144/28"]
lss_pe_address_prefix            = ["10.253.23.160/28"]
inv_db_address_prefix            = ["10.253.23.208/28"]
inv_vm_address_prefix            = ["10.253.24.0/28"]
inv_function_app_address_prefix  = ["10.253.23.224/28"]
inv_pe_address_prefix            = ["10.253.23.240/28"]
event_hub_address_prefix         = ["10.253.24.48/28"]


kvap_vm_subnet_name    = "AZ_SNET_WE_VM"
kvap_vm_address_prefix = ["10.253.25.64/28"]
...
ch_appgtw_route_table_name     = "AZ_RT_WE_DEFAULT_CH_APPGTW"
ch_appgtw_route                = "Default-Route"
ch_appgtw_route_address_prefix = "0.0.0.0/0"
ch_appgtw_next_hop_type    = "Internet"
############################ Vpc Peering #################################
