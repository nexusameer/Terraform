...
environment                  = "PRD"
core_subscription_id         = "TBD"
app_subscription_id          = "TBD"
...
vnet_address_space        = ["10.253.42.0/23", "10.253.44.0/24", "10.253.45.0/24"]
sensor_vnet_address_space = ["10.253.46.0/26"]
vnet_ch_address_space     = ["10.253.48.0/23"]
kvap_address_space        = ["10.253.46.64/27"]
...
sensor_pe_address_prefix            = ["10.253.44.0/27"]
sensor_batch_account_address_prefix = ["10.253.44.32/28"]
sensor_functionapp_address_prefix   = ["10.253.44.64/29"]
sensor_db_address_prefix            = ["10.253.44.48/28"]
sensor_bastion_address_prefix       = ["10.253.44.192/26"]
...
webapp_sensor_address_prefix           = ["10.253.46.0/28"]
virtual_machine_sensor_address_prefix  = ["10.253.46.16/28"]
private_endpoint_sensor_address_prefix = ["10.253.46.32/28"]
...
aks_ch_address_prefix    = ["10.253.48.0/24"]
ch_pe_address_prefix     = ["10.253.49.16/28"]
ch_db_address_prefix     = ["10.253.49.0/28"]
ch_appgtw_address_prefix = ["10.253.49.32/27"]
...
d_bricks_container_address_prefix          = ["10.253.42.0/25"]
pe_d_bricks_managed_storage_address_prefix = ["10.253.43.16/28"]
pe_d_bricks_cp_address_prefix              = ["10.253.43.0/28"]
d_bricks_host_address_prefix               = ["10.253.42.128/25"]
...
ml_batch_account_address_prefix  = ["10.253.44.80/28"]
ml_function_app_address_prefix   = ["10.253.44.96/29"]
ml_pe_subnet_address_prefix      = ["10.253.44.104/29"]
lss_batch_account_address_prefix = ["10.253.44.112/28"]
lss_function_app_address_prefix  = ["10.253.44.128/29"]
lss_pe_address_prefix            = ["10.253.44.136/29"]
inv_db_address_prefix            = ["10.253.44.144/28"]
inv_vm_address_prefix            = ["10.253.44.184/29"]
inv_function_app_address_prefix  = ["10.253.44.160/29"]
inv_pe_address_prefix            = ["10.253.44.168/29"]
event_hub_address_prefix         = ["10.253.44.176/29"]


kvap_vm_subnet_name    = "AZ_SNET_WE_VM"
kvap_vm_address_prefix = ["10.253.46.64/28"]
...
############################ Action Group #################################
recipient = "dcprdenv.notifications@digycorp.com"
