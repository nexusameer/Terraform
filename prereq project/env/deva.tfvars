...
vnet_address_space        = ["10.253.6.0/23", "10.253.8.0/24"]
sensor_vnet_address_space = ["10.253.9.0/26"]
vnet_ch_address_space     = ["10.253.10.0/24"]
kvap_address_space        = ["10.253.9.64/26"]
...
sensor_pe_address_prefix            = ["10.253.6.192/27"]
sensor_batch_account_address_prefix = ["10.253.6.224/28"]
sensor_functionapp_address_prefix   = ["10.253.7.0/28"]
sensor_db_address_prefix            = ["10.253.6.240/28"]
sensor_bastion_address_prefix       = ["10.253.8.128/26"]
...
webapp_sensor_address_prefix           = ["10.253.9.0/28"]
virtual_machine_sensor_address_prefix  = ["10.253.9.32/28"]
private_endpoint_sensor_address_prefix = ["10.253.9.16/28"]
...
aks_ch_address_prefix    = ["10.253.10.0/25"]
ch_pe_address_prefix     = ["10.253.10.144/28"]
ch_db_address_prefix     = ["10.253.10.128/28"]
ch_appgtw_address_prefix = ["10.253.10.160/27"]
...
d_bricks_container_address_prefix          = ["10.253.6.0/26"]
pe_d_bricks_managed_storage_address_prefix = ["10.253.6.144/28"]
pe_d_bricks_cp_address_prefix              = ["10.253.6.128/28"]
d_bricks_host_address_prefix               = ["10.253.6.64/26"]
...
ml_batch_account_address_prefix  = ["10.253.7.48/28"]
ml_function_app_address_prefix   = ["10.253.7.64/28"]
ml_pe_subnet_address_prefix      = ["10.253.7.80/28"]
lss_batch_account_address_prefix = ["10.253.7.128/28"]
lss_function_app_address_prefix  = ["10.253.7.144/28"]
lss_pe_address_prefix            = ["10.253.7.160/28"]
inv_db_address_prefix            = ["10.253.7.208/28"]
inv_vm_address_prefix            = ["10.253.8.0/28"]
inv_function_app_address_prefix  = ["10.253.7.224/28"]
inv_pe_address_prefix            = ["10.253.7.240/28"]
event_hub_address_prefix         = ["10.253.8.48/28"]


kvap_vm_subnet_name    = "AZ_SNET_WE_VM"
kvap_vm_address_prefix = ["10.253.9.64/28"]
...
ch_routes               = {
  ...
  "AppGW-to-CH" = {
    address_prefix = "10.253.10.0/24"
    next_hop_type  = "VnetLocal"
  }
  "Route-to-Core-1" = {
    address_prefix = "10.253.6.0/23"
    next_hop_type  = "VirtualAppliance"
    next_hop_in_ip_address = "10.253.0.4"
  }
  "Route-to-Core-2" = {
    address_prefix = "10.253.8.0/24"
    next_hop_type  = "VirtualAppliance"
    next_hop_in_ip_address = "10.253.0.4"
  }
  "Route-to-onPrem" = {
...
core_nsg_name = "AZ_NSG_WE_CORE"
ch_nsg_name = "AZ_NSG_WE_CH"
kvap_nsg_name = "AZ_NSG_WE_KVAP"
app_nsg_name = "AZ_NSG_WE_APP"