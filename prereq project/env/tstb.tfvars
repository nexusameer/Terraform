...
environment                  = "TSTB"
core_subscription_id         = "63073a0a-53b2-4fc3-b025-9b42545c7b57"
app_subscription_id          = "c08ce3e6-7c64-4840-a9a4-0c00554562de"
management_subscription_id   = "54e40e11-f09e-481d-a80d-22eb8ad32ee6"
kcri_subscription_id         = "9489782e-39b6-4416-a29c-ee7489d9a043"
...
vnet_address_space        = ["10.253.30.0/23", "10.253.32.0/24"]
sensor_vnet_address_space = ["10.253.33.0/26"]
vnet_ch_address_space     = ["10.253.34.0/24"]
kvap_address_space        = ["10.253.33.64/26"]
...
sensor_pe_address_prefix            = ["10.253.30.192/27"]
sensor_batch_account_address_prefix = ["10.253.30.224/28"]
sensor_functionapp_address_prefix   = ["10.253.31.0/28"]
sensor_db_address_prefix            = ["10.253.30.240/28"]
sensor_bastion_address_prefix       = ["10.253.32.128/26"]
...
webapp_sensor_address_prefix           = ["10.253.33.0/28"]
virtual_machine_sensor_address_prefix  = ["10.253.33.32/28"]
private_endpoint_sensor_address_prefix = ["10.253.33.16/28"]
...
aks_ch_address_prefix    = ["10.253.34.0/25"]
ch_pe_address_prefix     = ["10.253.34.144/28"]
ch_db_address_prefix     = ["10.253.34.128/28"]
ch_appgtw_address_prefix = ["10.253.34.160/27"]
...
d_bricks_container_address_prefix          = ["10.253.30.0/26"]
pe_d_bricks_managed_storage_address_prefix = ["10.253.30.144/28"]
pe_d_bricks_cp_address_prefix              = ["10.253.30.128/28"]
d_bricks_host_address_prefix               = ["10.253.30.64/26"]
...
ml_batch_account_address_prefix  = ["10.253.31.48/28"]
ml_function_app_address_prefix   = ["10.253.31.64/28"]
ml_pe_subnet_address_prefix      = ["10.253.31.80/28"]
lss_batch_account_address_prefix = ["10.253.31.128/28"]
lss_function_app_address_prefix  = ["10.253.31.144/28"]
lss_pe_address_prefix            = ["10.253.31.160/28"]
inv_db_address_prefix            = ["10.253.31.208/28"]
inv_function_app_address_prefix  = ["10.253.31.224/28"]
inv_vm_address_prefix            = ["10.253.32.0/28"]
inv_pe_address_prefix            = ["10.253.31.240/28"]
event_hub_address_prefix         = ["10.253.32.48/28"]


kvap_vm_subnet_name    = "AZ_SNET_WE_VM"
kvap_vm_address_prefix = ["10.253.33.64/28"]
...
ch_routes               = {
  ...
  "AppGW-to-CH" = {
    address_prefix = "10.253.34.0/24"
    next_hop_type  = "VnetLocal"
  }
  "Route-to-Core-1" = {
    address_prefix = "10.253.30.0/23"
    next_hop_type  = "VirtualAppliance"
    next_hop_in_ip_address = "10.253.0.4"
  }
  "Route-to-Core-2" = {
    address_prefix = "10.253.32.0/24"
    next_hop_type  = "VirtualAppliance"
    next_hop_in_ip_address = "10.253.0.4"
  }
  "Route-to-onPrem" = {
...
############################ Action Group #################################
recipient = "dctstenv.notifications@digycorp.com"
